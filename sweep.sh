...
# elk sweep --net.seed 42 --template_path /home/laurito/elk/scripts/templates/random/train/imdb/32 --net crc --norm cluster --cluster_algo HDBSCAN --min_cluster_size 5 --models "mistralai/Mistral-7B-v0.1" --datasets imdb --skip_transfer_eval  --num_gpus 8 # --disable_cache

# elk sweep --net.seed 42 --template_path /home/laurito/elk/scripts/templates/random/train/imdb/128 --net crc --norm burns --cluster_algo None --models "mistralai/Mistral-7B-v0.1" --datasets imdb --skip_transfer_eval  --num_gpus 8 # --disable_cache
elk eval /home/wombat_share/laurito/elk_reporters/sweeps/charming-rubin/mistralai/Mistral-7B-v0.1/imdb mistralai/Mistral-7B-v0.1 imdb --template_path /home/laurito/elk/scripts/templates/random/eval/imdb/32/ --num_gpus 2 --norm False
