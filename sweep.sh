elk sweep --net.seed 42 --template_path /home/laurito/elk/scripts/templates/personas/train/truthfulqa/ --net ccs --norm burns --cluster_algo None --models "mistralai/Mistral-7B-v0.1" --datasets EleutherAI/truthful_qa_mc --skip_transfer_eval --num_gpus 2 --disable_cache
